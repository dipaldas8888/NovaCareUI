    ...
    <section className="relative w-full overflow-hidden pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        <motion.div
          ...
          <h1
            className="from-foreground/80 via-foreground to-foreground/80 bg-gradient-to-r bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl md:text-6xl">
            {aboutData.title}
          </h1>
        ...
        <div ref={missionRef} className="relative mx-auto mb-24 max-w-7xl">
          <motion.div
            ...
            <motion.div
              ...
              <div
                className="from-primary/20 to-primary/5 mb-6 inline-flex aspect-square h-16 w-16 flex-1 items-center justify-center rounded-2xl bg-gradient-to-br backdrop-blur-sm">
        ...
        <div ref={valuesRef} className="mb-24">
          <motion.div
            ...
            <h2
              className="from-foreground/80 via-foreground to-foreground/80 bg-gradient-to-r bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-4xl">
              Our Core Values
            </h2>
